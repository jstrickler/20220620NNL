...
ad minim veniam, quis nostrud exercitation ullamco M5 laboris nisi ut aliquip ex  
...
#  re.match()    match at beginning   "^" + pattern
#  re.fullmatch()   match entire string   "^" + pattern + "$"
